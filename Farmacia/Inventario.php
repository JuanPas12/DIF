...
<BODY>
    ...
    <DIV class="Prods" style="position: relative; top: 50px; left: 65px; width: 1400px;">
        ...
        <form action="Encontra.php" method="POST">
			...
			$SQL="SELECT * FROM productos P INNER JOIN proveedores PR ON P.ProveedorID = PR.ProveedorID 
            INNER JOIN categorias C ON P.CategoriaID = C.CategoriaID ORDER BY `P`.`NombreProducto` ASC";
