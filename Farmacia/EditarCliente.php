...
<HEAD>
    ...
    include('Base de Datos/Conexion/conexion.php');
      $CP=$_GET['clave'];
      $SQL="SELECT * FROM `clientes` WHERE `ClienteID` = $CP";
        ...
        <form action="ActualizarCliente.php" method="POST">
            <table>
                ...
                <tr>
                    ...
                    value="<?php echo $Fila['Nombre'];?>" style="width: 200px; font-size: 18px; border-radius: 5px;"></th>
                ...
                <input type="hidden" value="<?php echo $Fila['ClienteID'];?>" name="txtClaveA">
                <tr>
