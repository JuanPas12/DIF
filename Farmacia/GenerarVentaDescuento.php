    ...
    <DIV class="PuntoVenta">
        <TABLE>
                            ...
                            echo"
                                <tr>
                                    <TH scope='row' class='renglon' style='text-align: right'>
                                        ".$Fila['NombreProducto']."
                                        &nbsp;&nbsp;
                                            <a href='EliminarProductoOrdenD.php?prod=".$Fila['ProductoID']."&orden=".$Fila['OrdenID']."&desc=$descuento&total=$total'>
                    ...
                    <tr>
                        ...
                        <form action='Descuento.php?idorden=<?php echo $IDORDEN ?>&total=<?php echo $total ?>"' method='POST'>
                            <INPUT type="text" name="txtDescuento" maxlength="2" style="width: 27px; font-size: 18px"
                                requiered value="<?php echo $descuento ?>"
                                onKeypress="if (event.keyCode < 45 || event.keyCode > 57) event.returnValue = false;">
                            <input type='submit' value='%' name='btnDescuento' style='width: 35px; height: 35px; border: 0.5px' onclick="<?php $total = $total_final ?>">
                        </form>
                        </td>
                    </tr>
                </tbody>
            <tfoot>
                ...
                <tr>
                <form action="TerminarVentaDescuento.php?idventa=<?php echo $IDORDEN; ?>&total=<?php echo $total; ?>&desc=<?php echo $descuento; ?>" method="POST">
