...
$SQLB = "UPDATE `detalles_orden` SET `Estado` = 'T' WHERE `detalles_orden`.`OrdenID` = '$NoVenta';";
$SQLT = "UPDATE `ordenes` SET `Monto` = '$total', `ClienteID` = '$cliente' WHERE `ordenes`.`OrdenID` = $NoVenta;";
